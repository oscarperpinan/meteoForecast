...
mfProj <- list(gfs = "+proj=longlat +datum=WGS84",
...
mfExtent <- list(
    ...
    openmeteo = extent(-45.66076, 53.66080, 26.36829, 55.27661),
    meteogalicia4 = extent(-11.261331695726343, -5.101928395629246,
                     40.421302033295945, 45.230011083267385),
    meteogalicia12 = extent(-21.57982593066231, 6.358561301098035,
        33.63652645596269, 49.56899908853894),
    meteogalicia36 = extent(-49.18259341789055, 18.788995948788816,
...
runs <- list(gfs = c('00', '06', '12', '18'),
             meteogalicia = c('00', '12'),
             openmeteo = c('00', '06', '12', '18'),
             nam = c('00', '06', '12', '18'),
